...
yc serverless function version create \
  ...
  --environment VERTEX_PROJECT_ID=$VERTEX_PROJECT_ID,VERTEX_LOCATION=$VERTEX_LOCATION,GEMINI_MODEL_ID=$GEMINI_MODEL_ID,BOT_TOKEN=$BOT_TOKEN,GOOGLE_APPLICATION_CREDENTIALS=$GOOGLE_APPLICATION_CREDENTIALS,AUTO_COMMENT_ENABLED=$AUTO_COMMENT_ENABLED \
